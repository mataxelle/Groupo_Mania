<template>
  <v-container>
    ...
    <v-container>
      <v-card>
        <v-card-title>A propos de de la plateforme de Groupomania</v-card-title>
        <v-card-subtitle>Cher membres,</v-card-subtitle>
        <v-card-text>
          ...
          Aliquam euismod libero eu enim. Nulla nec felis sed leo placerat imperdiet. Aenean suscipit nulla in justo. Suspendisse cursus rutrum augue. Nulla tincidunt tincidunt mi. Curabitur iaculis,
